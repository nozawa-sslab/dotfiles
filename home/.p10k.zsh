# Generated by Powerlevel10k configuration wizard on 2024-01-18 at 16:54 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%B%F{red}%n %F{white}in %B%F{blue}%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{red}%n%F{blue}@%m'
